...
/**
 * The Madeline that appears when you load into a level. She has no collision or
 * interaction with the environment, she is just a drawing.
 */
public class SpawningMadeline {
	...
	/**
	 * Creates an object that looks like Madeline but without collision for the
	 * purpose of spawning her into the level
	 * 
