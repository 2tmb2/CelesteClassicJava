...
public class BigChest extends CollisionObject {
	...
	public void drawOn(Graphics2D g2)
	{
		...
		if (true)
		{
			g2.drawImage(scaledMap, getX(), drawY, getX() + SPRITE_WIDTH, drawY + spriteHeight, (CHEST_LOCATION_X - GAME_WIDTH), chestLocationY + 1, ((CHEST_LOCATION_X - GAME_WIDTH)) + SPRITE_WIDTH, chestLocationY + spriteHeight, null);
		}
	}
