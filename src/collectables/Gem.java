...
/**
 * A Gem increases Madeline's maximum number of dashes to two
 */
	...
	public void drawOn(Graphics2D g2) {
		if (!hasBeenCollected) {
			...
			g2.drawImage(MainApp.SCALED_MAP, getX(), getY(), getX() + Constants.SPRITE_WIDTH,
					getY() + Constants.SPRITE_HEIGHT, (GEM_LOCATION_X - Constants.GAME_WIDTH), GEM_LOCATION_Y + 1,
					((GEM_LOCATION_X - Constants.GAME_WIDTH)) + Constants.SPRITE_WIDTH,
					GEM_LOCATION_Y + Constants.SPRITE_HEIGHT, null);
		}
	}
